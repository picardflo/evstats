...
function StatCard({ label, value, unit, color = 'primary.main', sub }) {
  return (
      ...
      {data.length === 0 ? (
        ...
        <>
          ...
          <Grid container spacing={2} sx={{ mb: 3 }}>
            ...
            <Grid item xs={6} sm={4} md={2}>
              <StatCard label="Énergie" value={totals.energy.toFixed(1)} unit="kWh" color={COLORS.energy} sub={`~${avgKwhPerSession.toFixed(1)} kWh/session`} />
            </Grid>
            <Grid item xs={6} sm={4} md={2}>
              <StatCard label="HC" value={totals.hc.toFixed(1)} unit="kWh" color={COLORS.hc} sub={`${hcPct.toFixed(1)}% de l'énergie`} />
            </Grid>
            <Grid item xs={6} sm={4} md={2}>
              <StatCard label="HP" value={totals.hp.toFixed(1)} unit="kWh" color={COLORS.hp} sub={`${hpPct.toFixed(1)}% de l'énergie`} />
            </Grid>
            <Grid item xs={6} sm={4} md={2}>
              <StatCard label="Coût moyen/session" value={avgCostPerSession.toFixed(2)} unit="€" color={COLORS.cost} sub={`total ${totals.cost.toFixed(2)} €`} />
            </Grid>
            <Grid item xs={6} sm={4} md={2}>
              <StatCard label="Durée" value={(totals.duration / 60).toFixed(1)} unit="h" color="secondary.main" sub={`~${(totals.duration / totals.sessions).toFixed(0)} min/session`} />
            </Grid>
          </Grid>
